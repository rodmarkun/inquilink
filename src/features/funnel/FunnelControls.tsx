...
export function PlanManager() {
  ...
  if (!status?.subscription) return <div className="funnel-empty"><strong>No hay una suscripción activa</strong><p>Activa primero tu suscripción para poder gestionar el plan.</p>{error && <p className="funnel-feedback funnel-feedback--error">{error}</p>}</div>
